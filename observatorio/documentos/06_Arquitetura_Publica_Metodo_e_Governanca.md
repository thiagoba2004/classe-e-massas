...
## ARQUITETURA PÚBLICA, MÉTODO COMUM E GOVERNANÇA

### Documento Canônico de Portais, Dados e Implantação
...
- fontes, versões, trechos e proveniência;

- mandatos, filiações, eleições, assembleias e delegações;

- eventos de luta, negociações, instrumentos e resultados;

- indicadores observados, estimados e derivados.

# 5. Estados epistemológicos

| **Estado**    | **Uso**                                                  |
|---------------|----------------------------------------------------------|
| Hipótese      | proposição a investigar; não publicar como constatação   |
| Estimativa    | cálculo com premissas e incerteza explícitas             |
| Provisório    | dado documentado ainda sujeito a validação               |
| Comprovado    | sustentado por fonte adequada ao enunciado               |
| Controvertido | fontes relevantes divergem                               |
| Desconhecido  | não há base suficiente; não preencher por plausibilidade |

# 6. Governança documental

- Toda mudança relevante recebe versão, data, justificativa e relação com documentos anteriores.

- Fontes históricas nunca são sobrescritas; correções geram novo registro.

- Mudanças de schema exigem avaliação de compatibilidade.

- Decisões estruturais dependem de aprovação humana explícita.
...
# 8. Critério de prioridade

Priorizar tarefas que aumentem simultaneamente memória, comparabilidade e capacidade de intervenção. Evitar coleta volumosa sem schema, publicação sem fonte, expansão sem responsável e visualização sem definição metodológica.
...
- Governança coletiva futura e papéis editoriais.

- Primeiro setor adicional ao núcleo bancário.

- Fórmulas de indicadores e regras de revisão por pares.

- Cronograma público e formas de participação da base.
